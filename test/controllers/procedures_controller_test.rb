...
class ProceduresControllerTest < ActionController::TestCase
  ...
  test "should create procedure" do
    assert_difference('Procedure.count') do
      post :create, procedure: { department_id: @procedure.department_id, link_address: @procedure.link_address, name: @procedure.name }
    end
  ...
  test "should update procedure" do
    patch :update, id: @procedure, procedure: { department_id: @procedure.department_id, link_address: @procedure.link_address, name: @procedure.name }
    assert_redirected_to procedure_path(assigns(:procedure))
  end
